...
func (qx *simplevecSpace) InsertVector(collectionName string, commitId uint64, vector gomath.Vector) error {
...
func (qx *simplevecSpace) UpdateVector(collectionName string, id uint64, vector gomath.Vector) error {
...
func (qx *simplevecSpace) FullScan(collectionName string, target gomath.Vector, topK int,
) (*ResultSet, error) {
...
func (qx *simplevecSpace) Load() error {
	...
	goto ExistsData
EmptyData:
	qx.vectors = make(map[uint64]gomath.Vector)
	return nil
ExistsData:
