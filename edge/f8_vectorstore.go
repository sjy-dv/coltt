...
func newF8Vectorstore(config CollectionConfig) *f8vecSpace {
	return &f8vecSpace{
		...
		vectors:        make(map[uint64]float8Vec),
...
func (qx *f8vecSpace) InsertVector(collectionName string, commitId uint64, vector gomath.Vector) error {
...
func (qx *f8vecSpace) UpdateVector(collectionName string, id uint64, vector gomath.Vector) error {
...
func (qx *f8vecSpace) FullScan(collectionName string, target gomath.Vector, topK int,
) (*ResultSet, error) {
