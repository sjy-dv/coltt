...
func (c *NotCriteria) Satisfy(doc *document.Document) bool {
...
func (c *BinaryCriteria) Satisfy(doc *document.Document) bool {
...
func (c *UnaryCriteria) Satisfy(doc *document.Document) bool {
	switch c.OpType {
	case ExistsOp:
		return c.exist(doc)
	case EqOp:
	...
	case FunctionOp:
		return c.Value.(func(*document.Document) bool)(doc)
	}
	return false
}
...
// Field represents a document fieldocument. It is used to create a new criteria.
...
func (c *UnaryCriteria) compare(doc *document.Document) bool {
...
func (c *UnaryCriteria) exist(doc *document.Document) bool {
	return doc.Has(c.Field)
}

func (c *UnaryCriteria) eq(doc *document.Document) bool {
...
func (c *UnaryCriteria) in(doc *document.Document) bool {
...
func (c *UnaryCriteria) contains(doc *document.Document) bool {
...
func (c *UnaryCriteria) like(doc *document.Document) bool {
